...
- Available Languages
  ...
  - **Fluent / Business**
    - <img src="https://flagcdn.com/16x12/us.png" width="16"> American English (Academic purposes)
...
- Protein Modeling
- Machine Learning (ML) & Artificial Intelligence (AI) for Science
- Scientific Computing

## Technical Skills

- **MD Simulation:** LAMMPS, OpenMM, CHARMM-GUI, MDAnalysis, MDTraj
- **QM Simulation:** Gaussian, GAMESS, Avogadro
- **Cheminformatics & Bioinformatics:** RDKit, BioPython
- **Protein Modeling**
  - **Structure Prediction:** AlphaFold3/2, RoseTTAFold2/1, ESMFold, OmegaFold, Chai-1, Boltz-2/1
  - **Docking Simulation:** AutoDock Vina
- **ML & AI for Science**
  - **Frameworks:** PyTorch, TensorFlow (Keras), Scikit-learn, imbalanced-learn
  - **Foundation Models:** Hugging Face Transformers, MoLFormer, ProtT5
  - **Explainable AI:** SHAP, Captum
- **Scientific Computing:** Python (Numpy, Pandas, SciPy), C, FORTRAN, Bash
- **Data Visualization:** ChimeraX, Ovito, VMD, PyMol, Matplotlib, Gnuplot, Igor64
- **Operating Systems & HPC:** Linux (Rocky Linux, CentOS, Ubuntu), MacOS, Windows, SLURM
- **Environments:** Git, VSCode, Vim, LaTeX, Anaconda
